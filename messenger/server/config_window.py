...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.ip_label = QLabel('Removed IP: ', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        self.ip_label_note = QLabel(
            ' stay empty for get connections from every IP',
            self)
    ...
    def save_server_config(self):
        ...
        try:
            ...
            message.warning(self, 'Error', 'Port must be an integer')
        else:
            ...
            if 1023 < port < 65536:
                ...
                message.warning(
                    self, 'Ошибка', 'Port must be from 1024 to 65536')
