...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_file_lable = QLabel('DB file name:', self)
        self.db_file_lable.move(10, 68)
        self.db_file_lable.setFixedSize(180, 15)

        self.db_file = QLineEdit(self)
        self.db_file.move(200, 66)
        self.db_file.setFixedSize(150, 20)

        self.port_label = QLabel('Connection port number', self)
        ...
        self.ip_label = QLabel('IP address connection', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        self.ip_label_note = QLabel('Empty field for get connections from different IPs', self)
